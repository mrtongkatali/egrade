...
<table id="curriculum_list_dt" class="sphr">
    ...
    <tr>
	    <td width="3%" align="left" valign="top">
            <ul class="dt_icons">
                <li><a id="edit" href="javascript:void(0);" onclick="javascript:_deleteCourseDialog('<?php echo Utilities::encrypt($c->getId()); ?>');" class="ui-icon ui-icon-trash" original-title="Delete"></a></li>
                <li><a id="delete" href="javascript:void(0);" onclick="javascript:_viewCourseDescriptionDialog('<?php echo Utilities::encrypt($c->getId()); ?>');" class="ui-icon ui-icon-search" original-title="View"></a></li>
            </ul>
        </td>
        
        
    	<td width="10%" align="left" valign="top"><?php echo $course->getCourseCode(); ?></td>
        <td width="20%" align="left" valign="top"><?php echo $course->getTitle(); ?></td>
